...
const QRCodeModal = ({ isOpen, onClose, qrCode, voucherData }) => {
  ...
  <div className="relative bg-gradient-to-r from-[#DD0303] to-[#b90202] p-2 text-white">
    ...
    <h2 className="text-xl font-bold mb-1">Your Voucher</h2>
    <p className="text-xs text-white/90">Show this QR code to redeem</p>
  </div>
  ...
  <div className="p-4 space-y-4">
    ...
    {/* Voucher Details (compressed layout) */}
    {voucherData && (
      <div className="space-y-2 bg-gray-50 dark:bg-zinc-900/50 p-3 rounded-xl text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-bold text-[#DD0303]">{voucherData.code}</span>
        </div>
    ...
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-xs">
      <p className="text-blue-800 dark:text-blue-200 leading-relaxed">
        📱 <strong>How to use:</strong> Show this QR code to the staff.
      </p>
    </div>
