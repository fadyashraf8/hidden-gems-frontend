...
const SubscriptionPlans = ({ compact = false }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-6">
      {/* ------ GOLD ------ */}
      {!isOwner && currentPlan !== "platinum" && (
        <div
          className={`relative bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-sm border-2 w-full md:w-[350px] ${
      ...
      {/* ------ PLATINUM ------ */}
      {!isOwner && currentPlan !== "gold" && (
        <div
          className={`relative bg-gray-900 text-white rounded-2xl p-6 shadow-xl border-2 w-full md:w-[350px] ${
            currentPlan === "platinum"
              ? "border-slate-400"
              : "border-transparent"
