...
export default function ProfileInfo({ user, onUpdateUser }) {
  ...
  return (
    <>
      <Card
        className={`w-full shadow-sm p-4 user-info ${
      ...
      >
        <CardBody className="space-y-5">
          ...
          {isEditing ? (
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <div
                className={`flex gap-3 mt-4 ${
                  textAlign === "text-right" ? "justify-start" : "justify-end"
                }`}
              >
                <Button
                  className="text-[#DD0303] bg-white"
                  variant="flat"
                ...
                <Button
                  className="bg-[#DD0303] text-white"
                  onPress={handleSave}
                  isLoading={isSaving}
                >
                  {t("save")}
            ...
            <div className="space-y-5 animate-in fade-in duration-300">
              <div className="group">
                ...
                <p
                  className={`p-3 rounded-xl border ${textAlign} ${
                    isDarkMode
          ...
          <div className="group pt-2 border-t border-gray-100">
            <p
              className={`text-sm font-semibold mb-1 mt-2 ${textAlign} ${
                isDarkMode ? "text-gray-400" : "text-gray-500"
              }`}
            >
              {t("email-label")}
          ...
          <div className="group">
            <p
              className={`text-sm font-semibold mb-1 group-hover:text-[#DD0303] transition ${textAlign} ${
                isDarkMode ? "text-gray-400" : "text-gray-500"
              }`}
            >
            ...
            <div
              className={`p-4 rounded-xl border-2 transition shadow-sm ${textAlign} flex items-center justify-between ${
                isDarkMode
                  ? "bg-gradient-to-r from-amber-900/30 to-yellow-900/30 border-amber-700 group-hover:from-amber-900/40 group-hover:to-yellow-900/40 group-hover:border-amber-600"
                  : "bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200 group-hover:from-amber-100 group-hover:to-yellow-100 group-hover:border-amber-300"
              }`}
            >
