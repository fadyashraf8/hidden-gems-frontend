...
export default function AddCategory() {
  const { t } = useTranslation("AdminAddCategory");
  ...
  const validateForm = () => {
    ...
    if (!imageFile) {
      newErrors.categoryImage = t("categoryImageRequired");
    }
    setErrors(newErrors);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${baseURL}/categories`, submitData, {
      ...
      .catch((err) => {
        ...
        showToast(
          err.response?.data?.message || t("categoryCreateFailed"),
          "error"
        );
      })
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">{t("createNewCategory")}</p>
      </div>
